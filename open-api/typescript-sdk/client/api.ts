...
export const AssetApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async downloadArchive(assetIdsDto: AssetIdsDto, key?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AssetApi.downloadArchive']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
        ...
        async downloadFile(id: string, key?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AssetApi.downloadFile']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
        ...
        async getDownloadInfo(downloadInfoDto: DownloadInfoDto, key?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DownloadResponseDto>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AssetApi.getDownloadInfo']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
...
export const AssetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        downloadArchive(requestParameters: AssetApiDownloadArchiveRequest, options?: RawAxiosRequestConfig): AxiosPromise<File> {
         ...
         * @throws {RequiredError}
         */
        downloadFile(requestParameters: AssetApiDownloadFileRequest, options?: RawAxiosRequestConfig): AxiosPromise<File> {
         ...
         * @throws {RequiredError}
         */
        getDownloadInfo(requestParameters: AssetApiGetDownloadInfoRequest, options?: RawAxiosRequestConfig): AxiosPromise<DownloadResponseDto> {
...
export class AssetApi extends BaseAPI {
     ...
     * @memberof AssetApi
     */
    public downloadArchive(requestParameters: AssetApiDownloadArchiveRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AssetApi
     */
    public downloadFile(requestParameters: AssetApiDownloadFileRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AssetApi
     */
    public getDownloadInfo(requestParameters: AssetApiGetDownloadInfoRequest, options?: RawAxiosRequestConfig) {
